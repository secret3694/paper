# paper
 ...
 - <a name="todo"></a>Estimating Training Data Influence by Tracing Gradient Descent(2020,全部损失分配到每一训练步，分配给训练步样本的价值)[[pdf](https://arxiv.org/pdf/2002.08484)]
 - <a name="todo"></a>Representer Point Selection for Explaining Deep Neural Networks
 - <a name="todo"></a>LESS: Selecting Influential Data for Targeted Instruction Tuning
 - <a name="todo"></a>Ddta Shapley In One Training Run[[pdf](https://arxiv.org/pdf/2406.11011)]
